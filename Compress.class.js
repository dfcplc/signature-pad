// Signature Pad Compression Class
var Compress = {};
    ...
    e.g. {x:800,y:200}
    */
    Compress.prototype.deflateFromJsonSignature = function(jsonSig, resolution) {
        var replacedSig,
        compressString = "",
            components,
            componentsLength, i;
        ...
        components =
        // rip off the opening and closing braces
        jsonSig.substring(2, jsonSig.length - 2)
        // strip the lx,ly,mx,my out of the string
        .replace(/"[lm][xy]":/g, "")
        // strip out braces and leave commas
        .replace(/},{/g, ",")
        // split the remaining string into the integer coordinates
        .split(',');
        ...
        for (i = 0; i < componentsLength; i = i + 1) {
            ...
            // convert coordinate to hex and then get the unicode value of the result. 
            // e.g. 125 => '}'
    ...
    /** Reinflates a compressed signature string:
          ...
          e.g. {x:800,y:200}
    */
    Compress.prototype.inflateToJsonSignature = function(deflatedSig, resolution) {
        var components = [],
            modifier = 1,
        ...
        // and convert from its hex value to a decimal coordinate value. 
        // e.g. '}' => 125 
